...
import { updateProfilePicture } from '../../services/usersApi';
...
const CropEasy = ({ photo, setOpenCrop }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className='bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg'
            >
                <h2 className='font-semibold text-dark-hard mb-02'>Crop Image</h2>
                <div
                ...
                <div>
                    ...
                    >Zoom:{`${Math.round(zoom * 100)}%`}</label>
                    <input
                        id='zoomRange'
                        min={1}
                        max={3}
                ...
                <div className='flex justify-between gap-2 flex-wrap'>
                    ...
                    >
                        {isLoading ? "Updating..." : "Crop & Upload"}
                    </button>
                </div>
            </div>
