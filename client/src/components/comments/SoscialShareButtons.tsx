...
const SoscialShareButtons: React.FC = ({ url, title }) => {
    return (
        <div className='w-full flex justify-between'>
            ...
            >
                <FaFacebookSquare
                    className='text-[#3b5998] w-12 h-auto'
                />
            </a>
            ...
            >
                <FaTwitterSquare
                    className='text-[#00acee] w-12 h-auto'
                />
            </a>
            <a
                target="_blank"
            ...
            >
                <FaRedditSquare
                    className='text-[#ff4500] w-12 h-auto'
                />
            </a>
            <a
                target="_blank"
            ...
            >
                <FaWhatsappSquare
                    className='text-[#25D366] w-12 h-auto'
                />
            </a>
        </div>
    )
...
export default SoscialShareButtons