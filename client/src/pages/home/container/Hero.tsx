                ...
                <div className='flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative'>
                    <div className="relative">
                        ...
                        <input type="text"
                         ...
                         text-dark-soft placeholder:text-[#959EAD] 
                         rounded-lg pl-12 pr-3 w-full py-3 focus:outline-none
                    ...
                    rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2
